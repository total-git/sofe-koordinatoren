...
\begin{itemize}
  \item Auf Paletten an der zugeordneten Lieferzone:
    ...
    \end{itemize}
  \item CO$_2$-Flaschen sind im Müllgang. Vorsichtig tragen! Mit Zurrgurten an Thekenelement festmachen und so gegen Umfallen schützen!
...
\begin{itemize}
  ...
  \item Aufgehängt werden müssen
    ...
    \end{itemize}
  \item Eigene Banner der Fachschaft o.ä.\ müssen mit uns \textbf{rechtzeitig} vorher abgesprochen werden und brauchen in jedem Fall ein Brandschutzzertifikat (B1).
