    ...
    \cleardoublepage
{
    \begin{center}
        \begin{tabular}{|p{2cm}|lrll|l|}
            ...
            \hline
            \multirow{4}{*}{Becher}
            & \SI{0.5}{\litre} verblombt &                            &      & Kiste  & \inputfield \\
            & \SI{0.3}{\litre} verblombt &                            &      & Kiste  & \inputfield \\
            & \SI{0.5}{\litre} unverblombt &                            &      & Kiste  & \inputfield \\
            & \SI{0.3}{\litre} unverblombt &                            &      & Kiste  & \inputfield \\ \hline
        \end{tabular}
    \end{center}
}
}
