    ...
    \cleardoublepage
{
    \begin{center}
        \begin{tabular}{|p{2cm}|lrll|l|}
            ...
            & Coca Cola       & 12$\times$\SI{1.0}{\litre}  & PET  & Kasten & \inputfield \\
            ...
            & Free Energy     & 6$\times$\SI{1.5}{\litre}   & Dose & Pack   & \inputfield \\
            ...
            \hline
            \multirow{4}{*}{Becher}
            & \SI{0.5}{\litre} original verblombt &                            &      & Kiste  & \inputfield \\
            & \SI{0.3}{\litre} original verblombt &                            &      & Kiste  & \inputfield \\
            & \SI{0.5}{\litre} angebrochen &                            &      & Kiste  & \inputfield \\
            & \SI{0.3}{\litre} angebrochen &                            &      & Kiste  & \inputfield \\ \hline
        \end{tabular}
    \end{center}
}
}
